...
**Layer 4 handles execution** — 23 active skills for specific tasks (issue-to-pr, debug-root-cause, figma-handoff, etc.) plus 2 subagents that run in isolated context for security and UX checks.
